...
module.exports = {
  ...
  POSITION_BATCH_DEADLOCK_RETRIES: RC.KAFKA.CONSUMER.TRANSFER.POSITION_BATCH.deadlock.retries,
  POSITION_BATCH_DEADLOCK_RETRY_DELAY_MS: RC.KAFKA.CONSUMER.TRANSFER.POSITION_BATCH.deadlock.retryDelayMs,
